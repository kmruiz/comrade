...
- Call remember ONLY when an important decision happened that will affect the architecture, design or product over the long term.
...
- When you meet a project-specific term the next session should understand, define it with remember_glossary (meaning + at least one reference to code or docs).

Record while the work is fresh. At the end of every task, ask: "what long-term decision or keyword would the next session need?" Then remember or remember_glossary it.
